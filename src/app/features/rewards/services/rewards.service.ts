...
export class RewardsService {
  ...
  getRewards(filters: RewardFilters = {}): Observable<RewardResponse> {
    ...
    if (filters.disabled !== undefined) {
      params = params.set("disabled", filters.disabled.toString());
    }
    if (filters.page) {
   ...
   */
  toggleRewardDisabled(id: string): Observable<RewardApiResponse> {
    return this.http.patch<RewardApiResponse>(`${this.apiUrl}/${id}/toggle-disabled`, {});
  }
